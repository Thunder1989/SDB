...
def emd(data, extrapolation='mirror', nimfs=12, shifting_distance=0.25):
    """
    Perform Empirical Mode Decomposition on a data vector.
    
    This function will return an array of all the Imperical Mode Functions as 
    defined in [1], which can be used for further Hilbert Spectral Analysis.
    ...
    if not(extrapolation):
        ...
        residual = data
        signals[:, 0] = data
        #NOT do spline fitting with periodic bounds
        inter_per = 0 
